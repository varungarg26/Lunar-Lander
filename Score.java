...
/**
 * A Score class that allows you to display a textual value on screen.
 * 
 * The Score is an actor, so you will need to create it, and then add it to the world
 * in Greenfoot.  If you keep a reference to the Score then you can change the text it
 * displays.  
 *
